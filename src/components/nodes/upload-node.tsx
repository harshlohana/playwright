...
export const UploadNode = memo(({ data }: UploadNodeProps) => {
    ...
    <div className="relative">
      ...
      >
        <div className="flex items-center gap-3 mb-2">
          ...
          <div className="font-bold text-sm text-slate-700">Upload File</div>
          {isRunning && (
        ...
        <div className="text-xs text-slate-600 space-y-1">
          <div className="font-mono truncate">
            {data.selector || 'input[type="file"]'}
          </div>
          <div className="text-slate-500 truncate">
            📄 {data.filePath || "file.pdf"}
          </div>
        </div>
      </div>
    </div>
