...
export const ScreenshotNode = memo(({ data }: ScreenshotNodeProps) => {
    ...
    <div className="relative">
      ...
      >
        <div className="flex items-center gap-3 mb-2">
          ...
          <div className="font-bold text-sm text-slate-700">Screenshot</div>
          {isRunning && (
        ...
        <div className="text-xs text-slate-600 space-y-1">
          ...
          {data.fullPage && <div className="text-slate-500">Full page</div>}
        </div>
      </div>
    </div>
  );
